...
加载完成 → 面板隐藏（点击画布即请求指针锁定；锁定成功提示"已锁定。WASD 移动…"，失败提示"请再次点击画布（确保焦点在页面内）"）
...
| 物理 | tickRate（48-128）、gravity/accelerate/airAccel/friction/maxSpeed/walkSpeed/crouchSpeed/stopSpeed/jumpSpeed、autobhop/bhopSpeedClamp/noPrestrafe |
