...
> **唯一未完成**：**真机手测**（用户侧；团队受「禁真实浏览器」约束不可代做）——指引见 `documents/phys-plan-discuss/t8-user-test-guide.md`。
...
- `documents/phys-plan-discuss/t8-user-test-guide.md`（**用户手测指引**，14 节）
- 设计基线：`plan-discuss/plan-v2.md`、`plan-discuss/t6-render-ahead-stance.md`、`plan-discuss/t4-acceptance-memo.md`、`documents/phys-plan-discuss/t2-bench-brief.md`、`temp/phys-plan-discuss/t3-memo-mode-designer.md`
