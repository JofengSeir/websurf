...
| web/*.js、dist/* 旧产物 | `apps/game/web/`、`game/dist/` | 可能是 v3 时代构建产物，运行前先 `npm run build:ts` / `build-dist.cmd`（`apps/game/README.md` 明示） |
