...
> ③ 三条消费链：Rust 侧 GLB 构建期回退、JS 侧运行期画质切换、缺失纹理比对（本文承接 `documents/archive/materials.md`、`documents/debug/archive/materials.md`、`documents/game/archive/materials.md` 三处旧档，收敛为根单篇）。
...
本篇收敛三处归档旧档（只读背景，内容未直接搬运、均经当前代码重验）：`documents/archive/materials.md`、`documents/debug/archive/materials.md`、`documents/game/archive/materials.md`（t1 归档，`git mv` 纯重命名）。
