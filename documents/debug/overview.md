...
| 目录/文件 | 行数 | 职责 | 细分文档 |
|---|---|---|---|
| `app.ts` | 2527 | 主入口：main() 装配、handleLoadBsp 编排、输入循环（rAF）、UI 绑定、物理面板消息处理、计时挑战接线 | [loading-pipeline](implementation/loading-pipeline.md)、[physics-panel](implementation/physics-panel.md)、[sequences](sequences.md) |
