...
> 工程根说明文档（操作/部署）：[apps/game/README.md](../game/README.md) · [apps/viewer/README.md](../viewer/README.md) · [test/dual-mode-harness/README.md](../test/dual-mode-harness/README.md)（验证工程）。debug 工程无根 README，其操作说明见 [documents/debug/overview.md](./debug/overview.md)。
