...
REM ---- toolchain gate: "where python" runs here, before dist\play.cmd is called ----
...
REM ---- [1/4] deps -> [2/4] wasm unless pkg\websurf_viewer_wasm_bg.wasm exists -> [3/4] ts -> [4/4] dist ----
...
REM Delegates to dist\play.cmd (generated by apps/viewer/scripts/build-dist.mjs),
REM forwarding PORT as its first argument; that launcher serves dist\ and opens the page.
